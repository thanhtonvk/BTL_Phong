use master
go
create database QLCuaHangQuanAo
go
use QLCuaHangQuanAo
go
...
as
begin
	select MaSP, TenSP,SoLuong,GiaBan,HinhAnh,MoTa,TenLoai,TenHang from SanPham,LoaiSanPham,Hang where SanPham.MaHang =Hang.MaHang and SanPham.MaLoai = LoaiSanPham.MaLoai
end
go
create proc GetSanPhamID @MaSP int
as
begin
	select MaSP, TenSP,SoLuong,GiaBan,HinhAnh,MoTa,TenLoai,TenHang from SanPham,LoaiSanPham,Hang where SanPham.MaHang =Hang.MaHang and SanPham.MaLoai = LoaiSanPham.MaLoai and SanPham.MaSP = @MaSP
end
go
create proc GetSanPhamTheoLoai @MaLoai int
as
begin
select MaSP, TenSP,SoLuong,GiaBan,HinhAnh,MoTa,TenLoai,TenHang from SanPham,LoaiSanPham,Hang where SanPham.MaHang =Hang.MaHang and SanPham.MaLoai = LoaiSanPham.MaLoai and SanPham.MaLoai = @MaLoai
end
go
create proc GetSanPhamTheoHang @MaHang int
as
begin
	select MaSP, TenSP,SoLuong,GiaBan,HinhAnh,MoTa,TenLoai,TenHang from SanPham,LoaiSanPham,Hang where SanPham.MaHang =Hang.MaHang and SanPham.MaLoai = LoaiSanPham.MaLoai and SanPham.MaHang = @MaHang
end
go
