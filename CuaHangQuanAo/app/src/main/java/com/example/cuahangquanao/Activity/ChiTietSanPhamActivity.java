...
import static com.example.cuahangquanao.Utils.Common.gioHangList;
...
public class ChiTietSanPhamActivity extends AppCompatActivity {
    ...
    TextView tvTen, tvGiaBan, tvSoLuong, tvLoai, tvHang, tvMota;
    ...
    private void loadDuLieu() {
        if (Common.sanPham != null) {
            ...
            tvLoai.setText("Loại sản phẩm: " + Common.sanPham.getTenLoai());
    ...
    private void anhXa() {
        ...
        tvLoai = findViewById(R.id.tv_loai);
